const telegramAPIToken = "GANTI_DENGAN_API_TOKEN_BOT_ANDA"; // Ganti dengan API token bot Anda
const telegramAPIURL = "https://api.telegram.org/bot" + telegramAPIToken;
const telegramAdminID = "GANTI_DENGAN_ID_USER_ADMIN_BOT_ANDA"; // Ganti dengan ID admin
...
const googleWebAppsURL = "GANTI_DENGAN_URL_WEB_APPS_ANDA"; // URL Web Apps Anda
const googleSheetID = "GANTI_DENGAN_GOOGLE_SHEETS_ID_ANDA";   // ID Google Sheet
